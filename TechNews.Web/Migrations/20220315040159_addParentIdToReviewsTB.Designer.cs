...
namespace TechNews.Web.Migrations
{
    ...
    [Migration("20220315040159_addParentIdToReviewsTB")]
    partial class addParentIdToReviewsTB
    {
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdentifierCode = "3dabc6fa632c4deb8de026f4ccd122d0",
                            IpAddress = "192.168.0.1",
                            IsActive = true,
                            Password = "20-2C-B9-62-AC-59-07-5B-96-4B-07-15-2D-23-4B-70",
                            PhoneNumber = "09120000000",
                            ProfilePhoto = "Default.png",
                            RegisterDate = new DateTime(2022, 3, 15, 7, 31, 58, 276, DateTimeKind.Local).AddTicks(9350),
                            RoleId = 3,
                            UserName = "محمد ساجدی"
                        });
                });
