...
namespace TechNews.Web.Migrations
{
    ...
    [Migration("20220323060359_insertBlacklistTable")]
    partial class insertBlacklistTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.BlackList", b =>
                {
                    ...
                    b.Property<string>("BlackListIpAddress")
                        .IsRequired()
                        .HasMaxLength(50)
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.Browser", b =>
                {
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.SentEmails", b =>
                {
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.Slider", b =>
                {
                    ...
                    b.Property<string>("ItemRefersTo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SlideBanner")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<DateTime>("SlideSubmitDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.Ticket", b =>
                {
                    ...
                    b.Property<DateTime?>("AnswerSubmitDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TechNews.DataLayer.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdentifierCode = "5907828818f84196bb3cba6cfe376b84",
                            IpAddress = "192.168.0.1",
                            IsActive = true,
                            Password = "20-2C-B9-62-AC-59-07-5B-96-4B-07-15-2D-23-4B-70",
                            PhoneNumber = "09120000000",
                            ProfilePhoto = "Default.png",
                            RegisterDate = new DateTime(2022, 3, 23, 10, 33, 58, 382, DateTimeKind.Local).AddTicks(2675),
                            RoleId = 3,
                            UserName = "محمد ساجدی"
                        });
                });
